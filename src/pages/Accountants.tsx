    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-emerald-900/20 to-gray-900">
      ...
      <header className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-xl border-b border-emerald-500/20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Button onClick={() => document.getElementById('contact-form')?.scrollIntoView({ behavior: 'smooth' })} size="lg" className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700">
            Найти бухгалтера
          </Button>
        </div>
      </header>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center max-w-5xl mx-auto mb-16">
            <Badge className="mb-6 bg-gradient-to-r from-emerald-600 to-teal-600 border-0 text-white px-6 py-2 text-lg">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <Card key={i} className="bg-white/5 backdrop-blur-lg border-emerald-500/30 p-6 hover:bg-white/10 transition-all">
                  <Icon name={stat.icon as any} className="w-10 h-10 mx-auto mb-3 text-emerald-400" />
      ...
      <section className="relative py-20 px-4 bg-gradient-to-b from-emerald-900/10 to-transparent">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <Input
                  ...
                  required
                  className="bg-white/10 border-emerald-500/30 text-white placeholder:text-gray-400 text-lg py-6"
                />
              </div>
              <div>
                <Input
              ...
              <Button 
                ...
                size="lg"
                className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-xl py-7 font-bold"
              >
                {isSubmitting ? 'Отправка...' : 'Получить бухгалтеров 📊'}
              </Button>
