...
const MarketplaceManagers = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-orange-900/20 to-gray-900">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center max-w-5xl mx-auto mb-16">
            <Badge className="mb-6 bg-gradient-to-r from-orange-600 to-amber-600 border-0 text-white px-6 py-2 text-lg">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <Card key={i} className="bg-white/5 backdrop-blur-lg border-orange-500/30 p-6 hover:bg-white/10 transition-all">
                  <Icon name={stat.icon as any} className="w-10 h-10 mx-auto mb-3 text-orange-400" />
                  <div className="text-4xl font-black text-transparent bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text mb-2">
                    {stat.value}
                  </div>
      ...
      <section className="relative py-20 px-4 bg-gradient-to-b from-orange-900/10 to-transparent">
