    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-pink-900/20 to-gray-900">
      ...
      <header className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-xl border-b border-pink-500/20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Button onClick={() => document.getElementById('contact-form')?.scrollIntoView({ behavior: 'smooth' })} size="lg" className="bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700">
            Найти маркетолога
          </Button>
        </div>
      </header>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center max-w-5xl mx-auto mb-16">
            <Badge className="mb-6 bg-gradient-to-r from-pink-600 to-rose-600 border-0 text-white px-6 py-2 text-lg">
              🚀 МАРКЕТИНГ-ЭЛИТА
            </Badge>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <Card key={i} className="bg-white/5 backdrop-blur-lg border-pink-500/30 p-6 hover:bg-white/10 transition-all">
                  <Icon name={stat.icon as any} className="w-10 h-10 mx-auto mb-3 text-pink-400" />
                  <div className="text-4xl font-black text-transparent bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text mb-2">
                    {stat.value}
                  </div>
      ...
      {/* Marketing Expertise */}
      <section className="relative py-20 px-4 bg-gradient-to-b from-pink-900/10 to-transparent">
