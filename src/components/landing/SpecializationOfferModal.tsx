...
const offers = {
  sales: {
    title: '🎯 Спецпредложение для отдела продаж',
  ...
  it: {
    title: '💻 Эксклюзив для IT-компаний',
  ...
  accountants: {
    title: '💼 Предложение для бухгалтерии',
  ...
  directors: {
    title: '👑 Executive Search Premium',
  ...
  retail: {
    title: '🛍️ Спецпредложение для ритейла',
